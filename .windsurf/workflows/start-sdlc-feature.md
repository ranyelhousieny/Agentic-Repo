...
> `scripts/maestro_repo_preflight.py` live in the **agentic-repo checkout**, not in the target repo.
...
3. Execute its steps in order, exactly as written:
   ...
   - Step 1: repo preflight (`$FRAMEWORK_HOME/scripts/maestro_repo_preflight.py`)
   - Steps 2-4: create the ticket, sprint + worklog, trigger Maestro
